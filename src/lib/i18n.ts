...
const translations = {
  ...
  "barMode": { tr: "Bar Modu", en: "Bar mode" },
  "barModeFloating": { tr: "Yuzen", en: "Floating" },
  "barModeDocked": { tr: "Kenara yapisik", en: "Edge-docked" },
  "dockEdge": { tr: "Yapisma kenari", en: "Dock edge" },
  "edgeRight": { tr: "Sag", en: "Right" },
  "edgeLeft": { tr: "Sol", en: "Left" },
  "edgeBottom": { tr: "Alt", en: "Bottom" },
  "expand": { tr: "Bari ac", en: "Expand bar" },
  "collapse": { tr: "Bari kapat", en: "Collapse bar" },
